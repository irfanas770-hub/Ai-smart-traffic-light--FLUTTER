...
class _addfineState extends State<addfine> {
  ...
  final TextEditingController _finetextController = TextEditingController();
  ...
  Future<void> _sendData() async {
    ...
    request.fields['ufine'] = ufine;
    request.fields['vid'] = id;
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  controller: _finetextController,
